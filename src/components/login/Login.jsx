              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                  ...
                  <div className='flex flex-col justify-center items-center gap-4'>
                   <button type="submit" className="md:w-1/4 text-black border-2 border-slate-400 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Log in</button>
                    <p className="text-sm">
                      Don’t have an account yet? <a href="/signup" className="font-semibold text-primary-600 hover:underline">Sign up</a>
                    </p>
                  </div>
