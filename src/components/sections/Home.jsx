  ...
  return (
    <>
      ...
      <main className=" h-fit flex flex-col gap-16 bg-slate-100">
        <div className="relative w-full h-[55vh] bg-center bg-cover" style={{ backgroundImage: "url('/src/assets/bg-home.jpeg')" }}>
        ...
        <hr className='mb-6 w-[25vw] md:w-[15vw] bg-black mx-auto' />
          ...
          <HomeCard src="/src/assets/mencatalog.jpg" alt="Men" link="/men" name="Men's clothing Catalog" />
          <HomeCard src="/src/assets/kidcatalog.jpg" alt="Kids" link="/kids" name="Kids's clothing Catalog" />
          <HomeCard src="/src/assets/womencatalog.jpg" alt="Women" link="/women" name="Women's clothing Catalog" />
          </div>
        </div> 
        <div className="women-product  w-[100vw] xl:w-[90vw] mx-auto mb-8  ">
          ...
          <div className='flex justify-center gap-y-4 gap-4 md:gap-6 flex-wrap'>
            <ProductCard src="/src/assets/products/product1.webp" name="Laxmipati Sarees " detail="Printed Bollywood Chiffon Saree " new_price="₹2,268" old_price="₹4,535" discount='49% off' />
            <ProductCard src="/src/assets/products/product2.webp" name=" SIRIL  " detail="Woven, Embellished, Self Design Banarasi Silk Saree " new_price="₹719" old_price="₹5,019" discount='85% off' />

            <ProductCard src="/src/assets/products/product3.webp" name=" Tibra Attire" detail="Women Cotton Blend Kurti Pant Dupatta Set" new_price="₹479" old_price="₹1,499" discount='68% off' />

            <ProductCard src="/src/assets/products/product4.webp" name=" riddhisa fashion" detail="Embroidered Bollywood Net Saree  (Black)" new_price="₹500" old_price="₹2,999" discount='88% off' />
